...
entries_frame = Frame(root, bg="#F9E8D9")
entries_frame.pack(side=TOP, fill=X)
title = Label(entries_frame, text="Employee Management System", font=("TimesNewRoman",20,"bold"),bg="#F9E8D9",fg="#EE7214")
title.grid(row=0, columnspan=20, padx=450, pady=20, sticky="W")

lblName = Label(entries_frame, text="Name", font=("TimesNewRoman", 16), bg="#F9E8D9",fg="black")
lblName.grid(row=1, column=0, padx=10, pady=10, sticky="w")
txtName = Entry(entries_frame, textvariable=name, font=("TimesNewRoman", 16), width=20, bg="white",fg="black")
txtName.grid(row=1, column=1, padx=10, pady=10, sticky="w")

lblAge = Label(entries_frame, text="Age", font=("TimesNewRoman", 16), bg="#F9E8D9",fg="black")
lblAge.grid(row=1, column=2, padx=10, pady=10, sticky="w")
txtAge = Entry(entries_frame, textvariable=age, font=("TimesNewRoman", 16), width=20, bg="white",fg="black")
txtAge.grid(row=1, column=3, padx=10, pady=10, sticky="w")

lbldoj = Label(entries_frame, text="D.O.J", font=("TimesNewRoman", 16), bg="#F9E8D9",fg="black")
...
lblEmail = Label(entries_frame, text="Email", font=("TimesNewRoman", 16), bg="#F9E8D9",fg="black")
lblEmail.grid(row=2, column=2, padx=10, pady=10, sticky="w")
txtEmail = Entry(entries_frame, textvariable=email, font=("TimesNewRoman", 16), width=20, bg="white",fg="black")
txtEmail.grid(row=2, column=3, padx=10, pady=10, sticky="w")

lblGender = Label(entries_frame, text="Gender", font=("TimesNewRoman", 16), bg="#F9E8D9",fg="black")
...
lblContact = Label(entries_frame, text="Contact No", font=("TimesNewRoman", 16), bg="#F9E8D9",fg="black")
...
lblAddress = Label(entries_frame, text="Address", font=("TimesNewRoman", 16), bg="#F9E8D9",fg="black")
...
btn_frame = Frame(entries_frame, bg="#F9E8D9")
